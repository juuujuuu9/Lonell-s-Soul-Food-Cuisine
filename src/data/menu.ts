...
export const dishes: Dish[] = [
  {
    ...
    longDescription: "Our signature oxtails are slow-braised for hours until they reach fall-off-the-bone tenderness. Seasoned with our proprietary blend of herbs and spices, then simmered in a rich, savory gravy. Served with your choice of two classic Southern sides. This is the dish that put Lonnell's on the map — don't visit without trying it.",
    price: "$32",
    category: "Dinner Plates",
    dietaryTags: ["Gluten-Free option"],
    seoTitle: "Oxtails — Best Soul Food Oxtails in South Los Angeles | Lonnell's",
    seoDescription: "Try Lonnell's award-winning oxtails in South LA. Slow-braised, fall-off-the-bone tender, served with two Southern sides. Our most popular dish. Dine-in, takeout, or delivery.",
  ...
  },
  {
    ...
    category: "Dinner Plates",
    dietaryTags: [],
    seoTitle: "Fried Chicken — Best Soul Food Fried Chicken in South LA | Lonnell's",
    seoDescription: "Crispy, juicy fried chicken at Lonnell's Soul Food in South Los Angeles. Buttermilk-marinated, hand-dredged, and fried to order. Served with two sides. Dine-in or takeout.",
  ...
  },
  {
    ...
    category: "Dinner Plates",
    dietaryTags: ["Gluten-Free option"],
    seoTitle: "Catfish — Louisiana-Style Fried Catfish in South LA | Lonnell's",
    seoDescription: "Crispy Louisiana-style fried catfish at Lonnell's Soul Food in South Los Angeles. Cornmeal-dusted, perfectly seasoned, served with two sides. Dine-in, takeout, or delivery.",
  ...
  },
  {
    ...
    category: "Dinner Plates",
    dietaryTags: ["Gluten-Free option"],
    seoTitle: "Short Ribs — Weekend Special Braised Short Ribs South LA | Lonnell's",
    seoDescription: "Weekend-only slow-braised short ribs at Lonnell's Soul Food in South Los Angeles. Butter-tender, rich sauce, served with two sides. Available Friday & Saturday. Dine-in or takeout.",
  ...
  },
  {
    ...
    category: "Dinner Plates",
    dietaryTags: ["Gluten-Free option"],
    seoTitle: "Pork Chops — Thick-Cut Soul Food Pork Chops in South LA | Lonnell's",
    seoDescription: "Thick-cut, seasoned-to-order pork chops at Lonnell's Soul Food in South Los Angeles. Pan-seared and juicy, served with two Southern sides. Dine-in, takeout, or delivery.",
  ...
  },
  {
    ...
    category: "Dinner Plates",
    dietaryTags: [],
    seoTitle: "Meatloaf — Homestyle Soul Food Meatloaf in South LA | Lonnell's",
    seoDescription: "Homestyle meatloaf at Lonnell's Soul Food in South Los Angeles. Rich, savory, served with gravy and two Southern sides. Dine-in, takeout, or delivery.",
  ...
  },
  {
    ...
    seoTitle: "Turkey Chop — Lean Soul Food Turkey Chop in South LA | Lonnell's",
    seoDescription: "Lean, flavorful turkey chop at Lonnell's Soul Food in South Los Angeles. Cooked to order, served with two Southern sides. A lighter soul food option. Dine-in or takeout.",
  ...
  },
  {
    ...
    category: "Dinner Plates",
    dietaryTags: ["Gluten-Free option"],
    seoTitle: "Brisket — Slow-Smoked Soul Food Brisket in South LA | Lonnell's",
    seoDescription: "Slow-smoked brisket at Lonnell's Soul Food in South Los Angeles. Tender, sliced and sauced, served with two Southern sides. Dine-in, takeout, or delivery.",
  ...
  },
  {
    ...
    category: "Dinner Plates",
    dietaryTags: ["Gluten-Free option"],
    seoTitle: "Baked Chicken — Oven-Roasted Soul Food Chicken in South LA | Lonnell's",
    seoDescription: "Oven-roasted baked chicken at Lonnell's Soul Food in South Los Angeles. Golden-brown, perfectly seasoned, served with two sides. A lighter soul food option. Dine-in or takeout.",
  ...
  },
  {
    ...
    seoTitle: "Peach Cobbler — Southern-Style Peach Cobbler in South LA | Lonnell's",
    seoDescription: "Warm Southern-style peach cobbler at Lonnell's Soul Food in South Los Angeles. Spiced peaches, buttery golden crust, made in-house. The perfect soul food dessert.",
